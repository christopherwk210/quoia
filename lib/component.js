 ...
 * @property {any} [values] Object to pass to templating engine
 */ 
 ...
 * @property {Array<string>} [globalScripts] JS files to apply to this component and all child components
...
class Component {
  ...
  constructor(options) {
    ...
    let componentID = shortID();
    
    // Save ID to component
    this.build.id = componentID;
